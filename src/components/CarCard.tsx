import { Card, Spacer, CardContent, Text, Flex, Row, Link } from "vcc-ui"
        ...
        <div className={styles.cardWrapper}>
                ...
                <Flex extend={{
                    ...
                    flexDirection: 'row'
                        ...
                        <Link href="https://www.volvocars.com/" arrow="right">SHOP</Link>
                        <Link href="https://www.volvocars.com/" arrow="right">LEARN</Link>
                </Flex>
        </div>
    )
}